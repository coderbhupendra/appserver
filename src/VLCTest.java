...
class VLCTest {
  ...
  public static void main(String[] args) throws Exception {
    InetAddress localhost = InetAddress.getByName("192.168.43.169");
    Socket socket = new Socket("192.168.43.169",1001);
    ...
    out.write("add C:/Users/BHUPENDRA SINGH/Desktop/pro/3.mp4\n".getBytes());
